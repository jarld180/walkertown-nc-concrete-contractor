...
const Home3: React.FC<HomeProps> = ({ cityName = "Walkertown" }) => {
  const mapUrl = cityName === "Walkertown" 
    ? "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3263.1!2d-80.7128!3d35.1167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8854210909090909%3A0x8854210909090909!2sWalkertown%2C%20NC!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right" data-aos-duration="1000">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link to={cityName === "Walkertown" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="bg-white border-2 border-black text-black px-8 py-4 rounded-2xl font-bold text-center hover:border-black transition-all">
                  Our Work
                </Link>
              </div>
            </div>
          ...
          <div className="space-y-32">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <Link to={cityName === "Walkertown" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="font-bold flex items-start group text-black">
              ...
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/driveways/option 2.png" alt="Concrete Driveway Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/foundations/option 2.jpg" alt="Foundations Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                ...
                <Link to={cityName === "Walkertown" ? "/foundations" : `/${cityName.toLowerCase().replace(" ", "-")}/foundations`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <Link to={cityName === "Walkertown" ? "/patios" : `/${cityName.toLowerCase().replace(" ", "-")}/patios`} className="font-bold flex items-start group text-black">
                  Design Your Outdoor Oasis <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/patios/option 2.jpg" alt="Stamped Patios Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/pool-decks/option 2.jpg" alt="Pool Decks Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                  <Logo className="text-black w-8 h-8" />
                ...
                <Link to={cityName === "Walkertown" ? "/pool-decks" : `/${cityName.toLowerCase().replace(" ", "-")}/pool-decks`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              ...
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/garage-floors/option 2.jpg" alt="Garage Floors Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/sidewalks/option 2.jpg" alt="Sidewalks Walkertown NC" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">(336) 933-9182</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-start justify-center">
