...
const Home2: React.FC<HomeProps> = ({ cityName = "Walkertown" }) => {
  const isWalkertown = cityName === "Walkertown";
          ...
          <div className="grid md:grid-cols-12 gap-8">
            <div className="md:col-span-7 space-y-8" data-aos="fade-right">
              ...
              <div className="flex justify-between items-start pt-20">
                ...
                <Link to={isWalkertown ? "/foundations" : `/${cityName.toLowerCase().replace(' ', '-')}/foundations`} className="text-[10px] font-black uppercase tracking-widest border-b border-blue-600 pb-1 hover:text-black hover:border-gray-400 transition-all">Details</Link>
              </div>
            </div>
            <div className="md:col-span-5 space-y-8 pt-20" data-aos="fade-left">
              ...
              <div className="flex justify-between items-start pt-20">
                ...
                <Link to={isWalkertown ? "/patios" : `/${cityName.toLowerCase().replace(' ', '-')}/patios`} className="text-[10px] font-black uppercase tracking-widest border-b border-blue-600 pb-1 hover:text-black hover:border-gray-400 transition-all">Details</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-60 bg-white">
        <div className="max-w-[1600px] mx-auto px-6 md:px-20 flex flex-col md:flex-row justify-between items-start gap-20">
          ...
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-x-20 gap-y-12">
            {['Winston-Salem', 'Kernersville', 'Rural Hall', 'Stokesdale', 'Oak Ridge'].map((city, i) => (
          ...
          <div className="space-y-20">
            ...
            <div className="flex flex-col gap-12 border-t border-gray-200 pt-20">
              <div className="group">
                ...
                <a href="tel:3369339182" className="text-4xl font-light hover:italic transition-all text-black underline underline-offset-[12px] decoration-blue-200">(336) 933-9182</a>
              </div>
            </div>
          </div>
